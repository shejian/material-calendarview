...
public class DynamicSettersActivity extends AppCompatActivity implements OnDateLongClickListener {
    ...
    public void setSelectedPager(View view) {
        DialogsActivity.SimpleCalendarDialogFragment dialog = new DialogsActivity.SimpleCalendarDialogFragment();
        dialog.setmSelectedListener((qqq, date, selected) -> {
                    Toast.makeText(this, date.toString(), Toast.LENGTH_SHORT).show();
                    widget.setCurrentDate(date);
                }
        );
        dialog.show(getSupportFragmentManager(), "test-simple-calendar");
    }
